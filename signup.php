...
require './dao/usersDAO.php';
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if the user already exists
      ...
      $numberofthisman = new usersDAO();
      $varofthenumber = $numberofthisman->get_Users_number_by_user_email($username, $email);
    ...
    if ($varofthenumber !== 0) {
        ...
        $insertuser = new usersDAO();
        $insertuser->add_User($username,$email,$phone,$password);
    }
  }
}
  ?>
